      ...
      <div class="mediaList_container">
        <el-row>
          <div class="mediaList_handel">
            ...
            <span>
							<div class="block">
								<el-date-picker class="input-with-select" v-model="date" type="daterange" range-separator="-"
                                format="yyyy-MM-dd" value-format="yyyy-MM-dd" start-placeholder="创建日期"
        ...
        <div class="table_wrap">
          <el-table border :data="currentPlan" v-loading="loading" element-loading-text="拼命加载中"
            ...
            <el-table-column prop="rName" label="所在城市" min-width="8%" :filters="filtCity" :filter-method="filterCity"
