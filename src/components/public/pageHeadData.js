var pageHeadData = { media: { name:'媒介', pageData: [
            {name: '首页', path: '/media'},
            ...
            {name: '图片库', path: '/media'},
            {name: '操作指引', path: '/media'} ]}, super: { name:'超级运营', pageData: [
            ...
            {name: '图片库', path: '/'},
            {name: '画像申请', path: '/'},
            {name: '操作指引', path: '/'} ]}, operate: { name:'管理员', pageData: [
			...
			{name: '广告限制', path: '/'},
			{name: '账号设置', path: '/media'},
			{name: '操作指引', path: '/media'} ]}, sale: { name:'销售', pageData: [
            {name: '首页', path: '/sale'},
