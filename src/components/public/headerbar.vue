    ...
    <div class="ad_index_header">
        ...
        <div class="handle clearfix">
            <a href="#" class="ad_index_user" @click="showbox">
                <em>{{userName}}</em>
                <i class="uname fa fa-angle-down fa-lg"></i>
            </a>
...
export default {
    ...
    methods: {
        ...
        getPath() {
            ...
            if (urlPath.indexOf("superOperate") !== -1) {
                //superOperate 超级运营
                //    alert('superOperate')
                ...
                if (
                    supermOp === "/mediaList" ||
                    supermOp === "/mediaInput" ||
                    supermOp === "/mediaDetail"
                ) {
                    this.liIndex = 1;
                } else if (
                    supermOp === "/clientList" ||
                    supermOp === "/clientDetail"
                ) {
                    this.liIndex = 2;
                    ...
                    supermOp === "/createAccount" ||
                    supermOp === "/accountList"
                ) {
                    this.liIndex = 5;
            ...
            } else if (urlPath.indexOf("media") !== -1) {
                // media 媒介
                //    alert('media')
            ...
            } else if (urlPath.indexOf("sale") !== -1) {
                // sale 销售
