                        ...
                        <div class="content_bottom_form_wrap">
                            <el-form :model="companyForm" status-icon :rules="companyRules" ref="companyForm" label-width="100px" class="demo-ruleForm">
                                <el-form-item label="公司名称:" prop="cName">
                                    <el-autocomplete v-model.trim="companyForm.cName" :fetch-suggestions="querySearchAsync" placeholder="请输入内容" @select="handleSelect">
                                    </el-autocomplete>
                                    <!-- <el-autocomplete  v-if="isEdit" v-model.trim="companyForm.cName" :fetch-suggestions="querySearchAsync" placeholder="请输入内容" @select="handleSelect" >
                                        <el-select v-model="selectType" slot="prepend" style="width:55px;">
                                            <el-option label="修改" value="1"></el-option>
                                            <el-option label="新建" value="2"></el-option>
                                            <el-option label="获取" value="3"></el-option>
                                        </el-select>
                                    </el-autocomplete>
                            ...
                            .then(res => {
                                ...
                                if (mes.SysCode == 300200) {
                                    ...
                                    if (!userMsg.SysCode) {
                                        this.resetForm();
                                        MessageBox.confirm(
                                            `创建客户成功,该公司非你所建没有权限编辑公司信息,是否跳转到列表页面`,
                                            "提示",
                                            {
                                                showClose: false,
                                                confirmButtonText: "确定",
