            ...
            <div class="content_top_form_wrap">
              <el-form :model="clientForm" status-icon :rules="clientRules" ref="clientForm" label-width="100px"
                ...
                <el-form-item label="手机号码:" prop="phone">
                  <el-input v-model.number="clientForm.phone" maxlength="11" minlength="11"
                ...
                <el-form-item label="所在地:" prop="cityArr">
                  ...
                  <el-cascader :options="allProvince" v-model="clientForm.cityArr" separator="-"
                               :show-all-levels="false" @change="seleProClient"
            ...
            <div class="content_bottom_form_wrap">
              <el-form :model="companyForm" status-icon :rules="companyRules" ref="companyForm" label-width="100px"
                ...
                <el-form-item label="公司名称:" prop="cName">
                  ...
                  <el-autocomplete v-else v-model.trim="companyForm.cName" :fetch-suggestions="querySearchAsync"
                ...
                <el-form-item label="公司品牌:" prop="cBrand" class="tags">
                  ...
                  <el-tag v-for="(tag, index) in companyTags" :key="index" closable :disable-transitions="false"
                          @close="handleClose(tag)">
                    {{tag}}
                  </el-tag>
                  <el-input style="width: 90px" class="input-new-tag" v-if="inputVisible" v-model="inputValue"
                ...
                <el-form-item label="行业分类:" prop="industryIdArr">
                  ...
                  <el-cascader v-else placeholder="试试搜索：互联网" :options="bussiness" v-model="companyForm.industryIdArr"
                               filterable change-on-select @change="handleChange"></el-cascader>
                </el-form-item>
                ...
                <el-form-item label="所在城市:" prop="cityArr">
                  ...
                  <el-cascader v-else :options="allProvince" v-model="companyForm.cityArr" separator="-"
                               :show-all-levels="false" @change="seleProCom"
                               @active-item-change="handleItemChange"></el-cascader>
                </el-form-item>
